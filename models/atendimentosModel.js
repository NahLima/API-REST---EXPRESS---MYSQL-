...
const moment = require('moment') // ela formata a data pra gente
const conexao = require('../infraestrutura/dataBase/conexao')
const repositorio = require('../repositorios/atendimentoRep')
    ...
    construtor(){
        ...
        this.validacoes = [
            ...
            },
            {
                ...
                mensagem: 'Cliente deve conter no mínimo 3 caracteres'
            }
        ]
    }
